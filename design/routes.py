"""
Design Evaluation Routes
설계평가 라우트 - snowball link6 기반
"""
...
@bp_design.route('/rcm', methods=['GET', 'POST'])
@login_required
...
@bp_design.route('/api/save', methods=['POST'])
@login_required
...
@bp_design.route('/api/sessions/<int:rcm_id>')
@login_required
...
@bp_design.route('/api/create-session', methods=['POST'])
@login_required

"""
Catcher Link 3: 운영평가
Operating Effectiveness Testing - snowball link7 기반
"""
...
bp_link3 = Blueprint('operation', __name__, url_prefix='/operation')
...
@bp_link3.route('/rcm', methods=['GET', 'POST'])
@login_required
...
@bp_link3.route('/api/save', methods=['POST'])
@login_required
